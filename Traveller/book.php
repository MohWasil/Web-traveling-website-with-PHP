<?php
   ...
   if (isset($_POST['submit']))
   {
      ...
      $visit = $_POST['location'];
      $how_many = $_POST['guests'];
      $arrival = $_POST['arrivals'];
      $leaving = $_POST['leaving'];
      $input = "INSERT INTO book (Name, Email, Phone, Address_, Where_to, How_many, Arrival, Leaving)
      VALUES('$name', '$email', '$phone','$address', '$visit', '$how_many', '$arrival', '$leaving')";
...
<section class="booking">
   ...
   <form action="" method="post" class="book-form">
      ...
      <input type="submit" value="Log out" class="btn log" name="logout">
   </form>
